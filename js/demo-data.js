...
(function (global) {
  ...
  const REPORTS_CATALOG = {
    "Case Reports": [
      { id: "rep-work-type", name: "Cases by Work Type", desc: "Breakdown of live and closed cases across all work types.", chart: "doughnut" },
      ...
      { id: "rep-status", name: "Cases by Status", desc: "Live, pending, completed, and closed case distribution.", chart: "doughnut" },
      { id: "rep-milestone", name: "Cases by Milestone", desc: "Current milestone breakdown for all live cases.", chart: "horizontalBar" },
      { id: "rep-aging", name: "Case Aging Report", desc: "Days open by case, grouped into aging buckets.", chart: "bar" },
      { id: "rep-completion", name: "Case Completion Report", desc: "Monthly completion performance vs. proposed completion dates.", chart: "line" },
    ...
    "Operational Reports": [
      { id: "rep-workload", name: "User Workload", desc: "Active case and task load per user.", chart: "bar" },
      { id: "rep-task-perf", name: "Task Performance", desc: "Task completion rate and average turnaround.", chart: "line" },
      { id: "rep-activity", name: "Activity Analysis", desc: "Volume of case activities logged over time.", chart: "bar" },
  ...
  /* ---------------------------------------------------------------------- */
  /*  AI Insights (clearly demo-labelled)                                    */
  /* ---------------------------------------------------------------------- */
  const AI_INSIGHTS = [
    "12 cases have exceeded their expected milestone duration.",
    "7 legislation cases are approaching their proposed completion dates.",
    "3 cases may require management attention based on activity inactivity.",
    "Translation demand has increased 18% this month across Legislation and Legal Advice cases.",
  ];
  ...
  const AI_QUICK_QUESTIONS = [
    ...
    "Show cases requiring management attention.",
    "Summarize recent case activities.",
    "Identify cases approaching their completion date.",
  ];
  ...
  global.SLC = {
    ...
    AI_INSIGHTS, AI_QUICK_QUESTIONS,
